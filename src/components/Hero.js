      ...
      <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
          <h1 class="max-w-2xl mb-4 hero text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
            Payments tracking and managing solution for institutions
          </h1>
          <p class="max-w-2xl hero p mb-6 font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">
            Our platform helps your organization streamline your financial
            management processes by providing a centralized, easy-to-use system
        ...
        <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
          <img src={Funds} alt="Funds manager" />
          {/* <img
